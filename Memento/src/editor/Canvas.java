...
public class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        contentPanel.add(new JLabel("Select and drag to move."), BorderLayout.PAGE_START);
        contentPanel.add(new JLabel("Right click to change color."), BorderLayout.PAGE_START);
        contentPanel.add(new JLabel("Return: Ctrl+Z, Redo: Ctrl+R"), BorderLayout.PAGE_START);
